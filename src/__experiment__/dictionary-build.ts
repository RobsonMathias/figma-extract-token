...
function getStyleDictionaryConfig(brand: any, platform: any) {
  return {
    "source": [
      "dist-tokens/**/*.json",
    ],
    "platforms": {
      "web/js": {
        ...
        "buildPath": `dist-dictionary/web/${brand}/`,
        "prefix": "token",
        "files": [
      ...
      "styleguide": {
        ...
        "buildPath": `dist-dictionary/styleguide/`,
        "prefix": "token",
        "files": [
          {
      ...
      "ios": {
        ...
        "buildPath": `dist-dictionary/ios/${brand}/`,
        "prefix": "token",
        "files": [
          {
      ...
      "android": {
        ...
        "buildPath": `dist-dictionary/android/${brand}/`,
        "prefix": "token",
        "files": [
          {
